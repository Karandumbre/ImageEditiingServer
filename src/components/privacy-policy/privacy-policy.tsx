...
import {
  ...
  PrivacyPolicyHeadingStyled,
  PrivacyPolicyParagraphStyled,
  PrivacyPolicyParagraphListStyled,
  PrivacyPolicyTopHeadingStyled,
  PrivacyPolicyMainContainerView,
    ...
    <PrivacyPolicyMainContainerView>
      <ScrollView>
        <PrivacyPolicyContainer>
          ...
          <PrivacyPolicyParagraphStyled>
            Persona Studios built the Persona app as a Free app. This SERVICE is
            provided by Persona Studios at no cost and is intended for use as
            is.
          </PrivacyPolicyParagraphStyled>
          <PrivacyPolicyParagraphStyled>
          ...
          <PrivacyPolicyParagraphStyled>
            ...
            our Terms and Conditions, which is accessible at Persona unless
          ...
          <PrivacyPolicyParagraphStyled>
            ...
            including but not limited to We do not store any personal
            information when using our application. We just process your image
            and send back to the user.. The information that I request will be
          ...
          <PrivacyPolicyHeadingStyled>Log Data</PrivacyPolicyHeadingStyled>
          <PrivacyPolicyParagraphStyled>
          ...
          <PrivacyPolicyHeadingStyled>Cookies</PrivacyPolicyHeadingStyled>
          <PrivacyPolicyParagraphStyled>
          ...
          <PrivacyPolicyHeadingStyled>Security</PrivacyPolicyHeadingStyled>
          <PrivacyPolicyParagraphStyled>
          ...
          <PrivacyPolicyParagraphStyled>
            ...
            property rights related to it, still belong to Persona Studios.
          </PrivacyPolicyParagraphStyled>
          <PrivacyPolicyParagraphStyled>
            Persona Studios is committed to ensuring that the app is as useful
          ...
          <PrivacyPolicyParagraphStyled>
            The Persona app stores and processes personal data that you have
            ...
            mean that the Persona app won’t work properly or at all.
          </PrivacyPolicyParagraphStyled>
          <PrivacyPolicyParagraphStyled>
          ...
          <PrivacyPolicyParagraphStyled>
            ou should be aware that there are certain things that Persona
            Studios will not take responsibility for. Certain functions of the
            ...
            provider, but Persona Studios cannot take responsibility for the app
          ...
          <PrivacyPolicyParagraphStyled>
            Along the same lines, Persona Studios cannot always take
            ...
            you can’t turn it on to avail the Service, Persona Studios cannot
            accept responsibility.
          </PrivacyPolicyParagraphStyled>
          <PrivacyPolicyParagraphStyled>
            With respect to Persona Studios’s responsibility for your use of the
            ...
            so that we can make it available to you. Persona Studios accepts no
          ...
          <PrivacyPolicyParagraphStyled>
            ...
            to keep using the app. Persona Studios does not promise that it will
